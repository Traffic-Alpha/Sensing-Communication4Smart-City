...
### 2024
- Y. Xie, Q. Wu, G. Niu, M.O. Pun and Z. Han, "Online Access Scheduling in Space-Air-Ground Integrated Networks using Graph Neural Network-Enhanced Reinforcement Learning", accepted for publication in *IEEE Trans. on Vehicular Technology*, Oct. 2024.
- X. Ma, X. Xu, X. Zhang and M.O. Pun, "ASMFNet: Swin Transformer-based Adjacent-Scale Multimodal Fusion Network for Semantic Segmentation of Remote Sensing Data", accepted for publication in *IEEE Journal of Selected Topics in Applied Earth Observations and Remote Sensing*, Oct. 2024. [[Paper Link]](https://ieeexplore.ieee.org/document/10736654)
